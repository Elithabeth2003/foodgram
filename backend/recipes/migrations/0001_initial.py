# Generated by Django 3.2 on 2024-07-25 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.IntegerField(validators=[django.core.validators.MaxValueValidator(300), django.core.validators.MinValueValidator(1)], verbose_name='Время приготовления')),
                ('slug_for_short_url', models.CharField(max_length=10, unique=True, verbose_name='Слаг для короткой ссылки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(validators=[django.core.validators.MaxValueValidator(32), django.core.validators.MinValueValidator(1)], verbose_name='Количество')),
